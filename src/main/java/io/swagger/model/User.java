...
public class User {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, user.id) && Objects.equals(this.username, user.username)
				...
				&& Objects.equals(this.kyu, user.kyu);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, username, firstName, lastName, email, password, phone, userStatus, kyu);
	}
	...
	public String toString() {
		...
		sb.append("    kyu: ").append(toIndentedString(kyu)).append("\n");
		sb.append("}");
		return sb.toString();
	}
